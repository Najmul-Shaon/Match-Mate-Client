...
const WhyUs = () => {
  return (
    <div className="flex justify-center items-center">
      <div class="border border-red-600 w-1/2 max-w-sm p-4 bg-white  rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="w-1/2 border border-red-600">
        <DotLottieReact src="../../assets/whyUs.json" loop autoplay />
      </div>
    </div>
  );
};
